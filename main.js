...
const createMeshWithRandomPosition = (geometry, material) => {
  ...
  const [x, y, z] = Array(3)
    .fill()
    .map(() => THREE.MathUtils.randFloatSpread(170));
  // console.log(x, y, z);
...
Array(50)
  .fill()
  .map(() => createMeshWithRandomPosition(crystalGeometry, whiteMaterial));
Array(50)
  .fill()
  .map(() =>
    createMeshWithRandomPositionAndRotation(
